...
export const NIGERIA_STATES_AND_LGAS: Record<string, string[]> = {
  ...
  'Adamawa': [
    ...
    'Shelleng', 'Song', 'Toungo', 'Yewa North', 'Yola South'
  ],
  'Akwa Ibom': [
    ...
    'Ini', 'Itu', 'Mbo', 'Mkpat-Enin', 'Nsit-Atai', 'Nsit-Ibiom', 'Nsit-Ubium', 'Obot Akara',
  ...
  'Benue': [
    'Agatu', 'Apa', 'Ado', 'Buruku', 'Gboko', 'Guma', 'Gwer East', 'Gwer West',
  ...
  'Ekiti': [
    ...
    'Ido Osi', 'Ijero', 'Ikere', 'Ikole', 'Ilemeji', 'Irepodun/Ifelodun', 'Ise/Orun', 'Moba', 'Oye'
  ],
  'Enugu': [
  ...
  'Kaduna': [
    ...
    'Kudai', 'Lere', 'Makarfi', 'Sabon Gari', 'Sanga', 'Soba', 'Zangon Kataf', 'Zaria'
  ],
  'Kano': [
    'Ajingi', 'Albasu', 'Bagwai', 'Bebeji', 'Bichi', 'Bunkure', 'Dala', 'Dambatta',
    'Dawakin Kudu', 'Dawakin Tofa', 'Doguwa', 'Gabasawa', 'Garko', 'Garun Mallam',
    'Gaya', 'Gezawa', 'Gwale', 'Kabo', 'Kano Municipal', 'Karaye', 'Kibiya', 'Kiru',
  ...
  'Oyo': [
    ...
    'Ibarapa East', 'Ibarapa North', 'Iddo', 'Irepo', 'Iseyin', 'Itesiwaju', 'Iwajowa',
    'Iwajowa', 'Kajola', 'Lagelu', 'Ogbomosho North', 'Ogbomosho South', 'Ogo Oluwa',
    'Olorunsogo', 'Oluyole', 'Oona Ara', 'Orelope', 'Ori Ire', 'Oyo East', 'Oyo West',
    'Saki East', 'Saki West', 'Surulere'
  ],
  'Plateau': [
    'Barkin Ladi', 'Bassa', 'Bokkos', 'Jos East', 'Jos North', 'Jos South', 'Kanam',
    'Kanke', 'Langtang South', 'Langtang North', 'Mangu', 'Mikang', 'Pankshin',
...
export const getLgasForState = (stateName: string): string[] => {
  ...
  const keys = Object.keys(NIGERIA_STATES_AND_LGAS);
  const foundKey = keys.find(k => k.toLowerCase() === stateName.toLowerCase());
  return foundKey ? NIGERIA_STATES_AND_LGAS[foundKey] : [];
};
